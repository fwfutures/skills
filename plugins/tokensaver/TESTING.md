...
- Six Python unit tests passed for both transcript formats, stale/fresh/threshold decisions, malformed records, missing timestamps, platform SessionStart behaviour, and private bounded handoffs.
